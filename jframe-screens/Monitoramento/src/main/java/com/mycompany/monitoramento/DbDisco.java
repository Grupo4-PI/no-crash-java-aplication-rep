...
public class DbDisco {
    ...
    private Disco disco = looca.getGrupoDeDiscos().getDiscos().get(0);

    public DbDisco(Integer indice) {
         disco = looca.getGrupoDeDiscos().getDiscos().get(indice);
    }
    
    private String modelo = disco.getModelo();
    private String serial = disco.getSerial();
    private Long bytesEscrita = disco.getBytesDeEscritas() / 1024/1024/1024;
    private Long bytesLeitura = disco.getBytesDeLeitura() /1024/1024/1024;
    private Long escritas = disco.getEscritas()/ 1024/1024/1024;
    private Long leituras = disco.getLeituras()/ 1024/1024/1024;
